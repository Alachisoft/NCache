...
namespace Alachisoft.NCache.ContentOptimization.Caching
{
    class CacheAdapter : ICache
    {
        ...
        public static Version Version
        {
            get
            {
                AssemblyName name = typeof(Cache).Assembly.GetName();
                return name.Version;
            }
        }
        ...
        public ICache GetSynchronized(ReaderWriterLock syncLock)
        {
           return this;
        }

        public ICache GetSynchronized()
        {
            return this;
        }
