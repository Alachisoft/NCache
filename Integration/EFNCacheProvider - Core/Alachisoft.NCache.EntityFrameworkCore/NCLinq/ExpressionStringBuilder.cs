...
namespace Alachisoft.NCache.EntityFrameworkCore.NCLinq
{
    internal sealed class ExpressionStringBuilder : ExpressionVisitor
    {
        ...
        private ExtentsGenerator _extentGen;
        ...
        private readonly List<string> _queryCriteriaStr;
        private readonly List<Expression> _queryCriteriaExp;
        private readonly StringBuilder _criteriaBuilder;

        private ExpressionStringBuilder()
        {
            _out = new StringBuilder();
            _extentGen = new ExtentsGenerator();

            _queryCriteriaStr = new List<string>();
            _queryCriteriaExp = new List<Expression>();
            _criteriaBuilder = new StringBuilder();
        }

        public List<string> QueryCriteriaStr => _queryCriteriaStr;
        public List<Expression> QueryCriteriaExp => _queryCriteriaExp;

        public override string ToString()
        {
            Logger.Log(
                "ExpressionToString '" + _out.ToString() + "'",
        ...
        {
            _out.Append(s);
            _criteriaBuilder.Append(s);
        }

        private void Out(char c)
        {
            _out.Append(c);
            _criteriaBuilder.Append(c);
        }
        ...
        /// <summary>
        /// Output a given expression tree Criteria to a string.
        /// </summary>
        internal static List<string> CriteriaToStrings(Expression node)
        {
            Debug.Assert(node != null);
            ExpressionStringBuilder esb = new ExpressionStringBuilder();
            esb.Visit(node);
            return esb.QueryCriteriaStr;
        }

        internal static List<Expression> CriteriaToExpressions(Expression node)
        {
            Debug.Assert(node != null);
            ExpressionStringBuilder esb = new ExpressionStringBuilder();
            esb.Visit(node);
            return esb.QueryCriteriaExp;
        }
