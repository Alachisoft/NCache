    ...
    public class StresstestBase : StressTestParameters, IConfiguration
    {
        ...
        protected  void StartStress()
        {
            try
            {
                ...
                _taskManger = new TestStressManager(CacheName, ItemsCount, TestCaseIterations, TestCaseIterationDelay, GetsPerIteration, UpdatesPerIteration, DataSize, SlidingExpiration, ThreadCount, ReportingInterval, printLogo, OutputProvider, adapter);
