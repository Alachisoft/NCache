...
namespace Alachisoft.NCache.Automation.Util
{
    public class Message
    {
        ...
        public const string CREATECACHESERVER = "Specifies the NCache server names/ips where Cache should be configured, separated by commas e.g. 120.168.98.10, 120.168.98.9";
        ...
        public const string CREATE_CLIENT_CACHE = "Specifies the name or Id of Client Cache.";
        public const string PESSIMISTIC = "Specifies if pessimistic Client Cache Synchronization Mode should be enable  Default is Optimistic.";
        ...
        public const string GRACEFUL_STOP = "Specifies for graceful shutdown";
        ...
        public const string DEP_ASM_PATH = " Specifies the dependent assembly folder/path";
        ...
        public const string CONFIGURE_SECURITY_NODE_NAME = "Specifies the target node to enable/disable security.";
        ...
        public const string REMOVE_BACKING_SOURCE_CACHE_NAME = " Specifies the name of the cache for which backing source will be removed.";
        public const string REMOVE_BACKING_SOURCE_PROVIDER = "Specifies the provider name.";
        public const string REMOVE_BACKING_SOURCE_READTHRU = "Specifies if provided backing source is configured for ReadThru.";
        public const string REMOVE_BACKING_SOURCE_WRITETHRU = "Specifies if provided backing source is configured for WriteThru.";
        public const string REMOVE_COMPACT_TYPE = "Specifies the name of the cache for which compact type will be removed.";
        public const string REMOVE_COMPACT_CLASS = "Specifies the class for removing from compact serialization.";
        public const string REMOVE_QUERY_INDEX_CACHE = "   Specifies the name of the cache for which query index will be removed.";
        public const string REMOVE_QUERY_INDEX_CLASS = "Specifies the class for removing query index.";
        public const string REMOVE_QUERY_INDEX_ATTRIBUTE_LIST = "Specifies the attributes for removing from query index ($ separated) e.g. CustomerID$Name .... ";
        ...
        public const string DUMP_CACHE_KEYS_KEYFILTER = "Specifies the keys that contain this substring. By default it is empty.";
        ...
        public const string PROVIDERNAME = "Specifies the provider name.";
        ...
        public const string QUEUE_LIMIT = "Specifies the limit of operation queue.";
        ...
        public const string BRIDGE_ID = "Specifies the Bridge ID to be used.";
        ...
        public const string STATEOFBRIDGECACHE = "Cache State that can be either Active or Passive,Default is Active";
        public const string CONNECTIONSTATUSOFBRIDGECACHE = "Connection status for bridge cache is required that can be either connect or disconnect";
        public const string ALIAS = "Alias is like the alternate name of the cache you are using in as a Bridge Cache";
        public const string BRIDGESERVER = "Bridge Server is the node name or ip address of Bridge node";
        public const string CACHESERVER = "Cache Server is the node name or ip address of Cache Server";

        public const string NEWBRIDGENODE = "Specifies the server that has to be added as a bridge node.";
        public const string REMOVEBRIDGENODE = "Specifies the node that has to be removed from bridge.";
        ...
        public const string BRIDGEPORT = "Specifies the port on which bridge nodes listen.";

        public const string OUTPUTFILE ="Specifies the path of the output file in which configuration will be written.";
        ...
        public const string POR_TOPOLOGY_NAME = "partitioned-replica";
        public const string MIRROR_TOPOLOGY_NAME = "mirrored";
