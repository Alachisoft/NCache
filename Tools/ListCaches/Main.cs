...
namespace Alachisoft.NCache.Tools.ListCaches
{
    ...
    sealed class ListCachesTool
    {
        ...
        static private void PrintCacheInfo(string schema, string cacheName, bool isRunning, int pid)
        {
            ...
            if (isRunning)
            {
                ...
                Console.WriteLine("{0,-25} {1,-35} {2,-15}", cacheName, schemeName, status);
            }
            else
            {
        ...
        static private void PrintDetailedCacheInfo(CacheStatistics s, string topology, string partId, bool isRunning, string cacheName, string configString, string pid)
        {
            long MaxSize = 0;
            string schemeName = topology;
            bool running = isRunning;

            Console.WriteLine("Cache-Name:\t\t{0}", cacheName);
        ...
        static private void PrintDetailedCacheInfo(Cache cache, string partId, bool printConf, bool xmlSyntax)
        {
            ...
            Console.WriteLine("Cache-Name:       {0}", cache.Name);
