...
[assembly: AssemblyTitle("removequeryindex")]
[assembly: AssemblyDescription("RemoveQueryIndex Utility for NCache")]
...
namespace Alachisoft.NCache.Tools.RemoveQueryIndex
{
    ...
    internal sealed class AssemblyUsage
    {
        ...
        public static void PrintLogo(bool printlogo)
        {
            ...
            string logo = @"Alachisoft (R) NCache Utility RemoveQueryIndex. Version " + Common.ProductVersion.GetVersion() +
                @"
Copyright (C) Alachisoft 2017. All rights reserved.";
        ...
        static public void PrintUsage()
        {
            ...
            string usage = @"Usage: removequeryindex  [option[...]].

 cache-id
    Specifies the id/name of the cache for which query index will be removed. 

 /c /class
    Specifies the class for removing query index. 

Optional:

 /L /attrib-list
    Specifies the attributes for removing from query index ($ seperated) e.g. CustomerID$Name .... 
