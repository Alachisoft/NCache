...
namespace Alachisoft.NCache.Tools.RemoveQueryIndex
{
    ...
    internal sealed class AssemblyUsage
    {
        ...
        public static void PrintLogo(bool printlogo)
        {
            ...
            string logo = @"Alachisoft (R) NCache Utility RemoveQueryIndex. Version " + assembly.GetName().Version +
                @"
...
Optional:
 ...
 /L /attrib-list
    Specifies the attributes for removing from query index ($ seperated) e.g.
    CustomerID$Name .... 
