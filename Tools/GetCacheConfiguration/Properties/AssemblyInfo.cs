...
namespace Alachisoft.NCache.Tools.GetCacheConfiguration
{
    ...
    internal sealed class AssemblyUsage
    {
        ...
        public static void PrintLogo(bool printlogo)
        {
            ...
            string logo = @"Alachisoft (R) NCache Utility GetCacheConfiguration. Version " + Common.ProductVersion.GetVersion() +
                @"
Copyright (C) Alachisoft 2017. All rights reserved.";
 ...
 cache-id
    Specifies the id/name of the cache for which cache configuration will be generated. 
