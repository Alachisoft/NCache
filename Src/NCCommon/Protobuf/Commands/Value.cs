...
{
    [global::System.Serializable, global::ProtoBuf.Extended.ProtoContract(Name=@"Value")]
    public partial class Value : global::ProtoBuf.Extended.IExtensible
    {
      public Value() {}
      
    private readonly global::System.Collections.Generic.List<byte[]> _data = new global::System.Collections.Generic.List<byte[]>();
    [global::ProtoBuf.Extended.ProtoMember(1, Name=@"data", DataFormat = global::ProtoBuf.Extended.DataFormat.Default)]
