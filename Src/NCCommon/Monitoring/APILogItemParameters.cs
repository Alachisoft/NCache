...
namespace Alachisoft.NCache.Common.Monitoring
{
    ...
    public class APILogItemParameters
    {
        ...
        private Alachisoft.NCache.Common.Protobuf.Dependency _serverDependency;
        private bool _isResyncRequired;
        private string _accessType;
        private bool _getData;
        private int _chunkSize;
        private string _taskId;
        private string _entryProcessor;
        ...
        {
            get { return _serverDependency; }
            set { _serverDependency = value; }
        }
