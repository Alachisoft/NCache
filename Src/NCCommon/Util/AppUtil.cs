...
namespace Alachisoft.NCache.Common
{
    ...
    public class AppUtil
    {
        ...
        public static int GetRandomMonthlyTime(DateTime start, DateTime end)
        {
            long millisec = 0;
            DateTime randomTime = GetRandomDate(start, end);
            ...
            millisec = (long)(randomTime - DateTime.Now).TotalMilliseconds ;
            if (millisec < 0)
                millisec = 1000 * 60 * 30;
            return Convert.ToInt32(millisec);
        }
