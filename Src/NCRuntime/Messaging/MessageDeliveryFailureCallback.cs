...
namespace Alachisoft.NCache.Runtime.Caching
{
    ...
    /// <example>The following example demonstrates how to use the <see cref="MessageDeliveryFailureCallback"/> class to notifiy 
    ...
    /// </code>     
    /// 
    /// Then register for message delievery failure events.
    /// <code>
