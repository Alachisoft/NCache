...
{
    /// <summary>
    /// BucketTransferredException is thrown on Add/Insert operation in Partion cache when during the 
    /// node up process, a bucket is moved to another node and this node has received 
