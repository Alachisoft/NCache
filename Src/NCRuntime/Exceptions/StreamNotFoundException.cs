...
namespace Alachisoft.NCache.Runtime.Exceptions
{
    ...
    public class StreamNotFoundException :StreamException,ISerializable
    {
        ...
        /// Default constructor.
        /// </summary>
        public StreamNotFoundException(int errorCode) : base(errorCode) { }
        /// <summary>
        /// Default constructor.
        /// </summary>
        public StreamNotFoundException(int errorCode,string reason= "Stream not found in the cache.") : base(errorCode,reason) { }
