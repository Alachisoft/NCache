...
namespace Alachisoft.NCache.Runtime.Exceptions
{
    ...
    public class InternalCommandException: Exception
    {
        /// <summary>
        ...
        public InternalCommandException(string message) :base(message)
        {
        }
        /// <summary>
        ...
        public InternalCommandException(string message, Exception inner) : base(message, inner){}
    }
}
