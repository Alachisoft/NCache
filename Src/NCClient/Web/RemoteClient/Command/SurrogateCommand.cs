...
namespace Alachisoft.NCache.Client
{
    class SurrogateCommand : CommandBase
    {
        ...
        protected override void CreateCommand()
        {
            ...
            _surrogateCommand.command.Add(WrappedCommand.GetSerializedSurrogateCommand());//  ProtoBuf.Serializer.Serialize< WrappedCommand.ToByte(default(long), WrappedCommand.inquiryEnabled));
