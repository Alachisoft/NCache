...
namespace Alachisoft.NCache.Web.Command
{
    internal sealed class GetOptimalServerCommand : CommandBase
    {
        ...
        public GetOptimalServerCommand(string id, byte[] userName, byte[] password)
        {
            ...
            _getOptimalServerCommand.productVersion.MajorVersion1 =
                this.ParseToByteArray(_currentVersion.MajorVersion1);
            _getOptimalServerCommand.productVersion.MajorVersion2 =
                this.ParseToByteArray(_currentVersion.MajorVersion2);
            _getOptimalServerCommand.productVersion.MinorVersion1 =
                this.ParseToByteArray(_currentVersion.MinorVersion1);
            _getOptimalServerCommand.productVersion.MinorVersion2 =
