...
namespace Alachisoft.NCache.Web.Command
{
    internal class GetGroupNextChunkCommand : CommandBase
    {
        ...
        internal GetGroupNextChunkCommand(GroupEnumerationPointer pointer)
        {
            ...
            _getNextChunkCommand.groupEnumerationPointer =
                EnumerationPointerConversionUtil.ConvertToProtobufGroupEnumerationPointer(pointer);
        }
        ...
        protected override void CreateCommand()
        {
            ...
            base._command.getGroupNextChunkCommand = _getNextChunkCommand;
            base._command.type = Alachisoft.NCache.Common.Protobuf.Command.Type.GET_GROUP_NEXT_CHUNK;
        }
