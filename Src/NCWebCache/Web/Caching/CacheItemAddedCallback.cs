...
namespace Alachisoft.NCache.Web.Caching
{
    ...
    /// is added to the <see cref="Cache"/>.
    /// </summary>
    ...
    /// </remarks>
    /// <example>The following example demonstrates how to use the <see cref="CacheItemAddedCallback"/> class to notify 
    /// an application when an item is added to the application's <see cref="Cache"/> object. You could include this 
    ...
    /// </requirements>
    [Obsolete(
        "This delegate is deprecated. 'Please use CacheDataNotificationCallback(string key, CacheEventArg cacheEventArgs)'",
        false)]
    public delegate void CacheItemAddedCallback(string key);
}