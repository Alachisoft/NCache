            ...
            try
            {
                if (newDom != null)
                {
                    ...
                    if (newDom.CacheSettings != null)
                    {
                        ...
                        if (newDom.CacheSettings.ExpirationPolicy != null)
                        {
                            oldDom.ExpirationPolicy = newDom.CacheSettings.ExpirationPolicy;
                        }

                        else
                        {
                            oldDom.ExpirationPolicy = new Alachisoft.NCache.Config.Dom.ExpirationPolicy();
                        }
                        ...
                        if (newDom.CacheSettings.TaskConfiguration != null)
                        {
                            oldDom.TaskConfiguration = newDom.CacheSettings.TaskConfiguration;
                        }

                        else
                        {
                            oldDom.TaskConfiguration = new Alachisoft.NCache.Config.Dom.TaskConfiguration();
                        }
                        ...
                        if (newDom.CacheSettings.SQLDependencyConfig != null)
                        {
                            oldDom.SQLDependencyConfig = newDom.CacheSettings.SQLDependencyConfig;
                        }
