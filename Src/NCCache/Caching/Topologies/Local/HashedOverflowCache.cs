                        ...
                        if (loggedEnteries != null && loggedEnteries.Count > 0)
                        {
                            ...
                            if (updated != null && updated.Count > 0)
                            {
                                ...
                                while (ide.MoveNext())
                                {
                                    ...
                                    if (entry != null)
                                    {
                                        Insert(ide.Key, entry, false, false, null, LockAccessType.IGNORE_LOCK,new OperationContext(OperationContextFieldName.OperationType,OperationContextOperationType.CacheOperation));
                                    }
                                }
                            }
                        }
