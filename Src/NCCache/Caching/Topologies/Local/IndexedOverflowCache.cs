...
namespace Alachisoft.NCache.Caching.Topologies.Local
{
    ...
    internal class IndexedOverflowCache : OverflowCache
    {
        ...
        {
            //ICollection pkList = null;
            //ICollection skList = null;

            //if (_primary != null)
            //    pkList = _primary.SearchInternal(pred, values);
            //if (_secondary != null)
            //    skList = _secondary.SearchInternal(pred, values);

            //if (pkList != null && skList != null)
            //{
            //    ArrayList keyList = new ArrayList(pkList);
            //    keyList.AddRange(skList);
            //    return keyList;
            //}
            //else
            //{
