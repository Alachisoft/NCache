...
namespace Alachisoft.NCache.Caching.DataGrouping
{
    ...
    {
        /// <summary>
        /// InMemory Size of GroupInfoEntryInMemorySize class instance 
        /// which includes _subGroups ref [8 bytes],  
        /// _subGroupIndexSize[8 bytes] 
        /// and _subGroupsMaxCount[8 bytes] and 16 bytes overhead of .net
        /// </summary>
