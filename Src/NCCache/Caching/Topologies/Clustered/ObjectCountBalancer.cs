...
namespace Alachisoft.NCache.Caching.Topologies.Clustered
{
    ...
    /// </summary>
    class ObjectCountBalancer : IActivityDistributor
    {
        ILogger _ncacheLog;
        ...
        NodeInfo IActivityDistributor.SelectNode(ClusterCacheStatistics clusterStats, object data)
        {
            ...
            lock (memberInfos.SyncRoot)
            {
                ...
                {
                    NCacheLog.Error("ObjectCountBalancer.SelectNode", "strict group affinity, no node found to accomodate " + group + " data");
                    return null;
                }
