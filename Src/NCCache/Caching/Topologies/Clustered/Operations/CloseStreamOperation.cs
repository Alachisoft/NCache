...
{
    public class CloseStreamOperation :ICompactSerializable
    {
        private string _key;
        private string _lockHandle;
        private OperationContext _operationContext;

        public CloseStreamOperation() { }

        public CloseStreamOperation(string key, string lockHandle,OperationContext operationContext)
        {
            _key = key;
