...
{
    public class MessageLoggedOperation : LoggedOperationBase
    {
        public object Operation { get; set; }

        public override LoggedOperationType OperationType
        {
            get { return LoggedOperationType.MessageOperation; }
        }

        public MessageLoggedOperation(object operation)
        {
            Operation = operation;
        }
