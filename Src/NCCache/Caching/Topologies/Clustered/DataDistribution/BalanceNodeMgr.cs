...
namespace Alachisoft.NCache.Caching.Topologies.Clustered
{
    class BalanceNodeMgr
    {
        ...
        public DistributionMaps BalanceNodes(DistributionInfoData distInfo, ArrayList hashMap, Hashtable bucketStats, ArrayList members, int totalBuckets)
        {
            _hashMap = hashMap;
            _nodeBalData = new NodeBalanceData(hashMap, bucketStats, members, totalBuckets);
