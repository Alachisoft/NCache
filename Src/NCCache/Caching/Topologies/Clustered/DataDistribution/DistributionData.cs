...
namespace Alachisoft.NCache.Caching.Topologies.Clustered
{
    public class DistributionData
    {
        ...
        public DistributionData(ArrayList hashMap, Hashtable bucketStatistics, ArrayList members, ILogger NCacheLog, long cacheSizePerNode, int totalBuckets)
        {
            _members = members;
            ...
            for (int i = 0; i < totalBuckets; i++)
            {
                ...
                if (buckStats == null) buckStats = new BucketStatistics();
            ...
            if (NCacheLog!=null && NCacheLog.IsInfoEnabled) NCacheLog.Info("DistributionData()", "cacheDataSum = " + _cacheDataSum.ToString());

            //Initialize the two very important data pieces. All distribution is based on this.
            _bucketsPerNode = totalBuckets / (memberCount + 1);
