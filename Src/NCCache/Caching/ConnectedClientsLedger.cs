...
namespace Alachisoft.NCache.Caching
{
    public class ConnectedClientsLedger
    {
        ...
        public void ClientDisconnected(string clientId, Address node, DateTime disconnectTime)
        {
            lock (_lock)
            {
                ClientDisconnectedInternal(clientId, node, disconnectTime);
            }
        }
        ...
        public void ClientsDisconnected(ArrayList clients, Address node, DateTime disconnectTime)
        {
            lock (_lock)
            {
                foreach (string client in clients)
                {
                    ClientDisconnectedInternal(client, node, disconnectTime);
                }
            }
        }
