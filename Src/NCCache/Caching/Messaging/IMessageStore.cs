...
namespace Alachisoft.NCache.Caching.Messaging
{
    interface IMessageStore
    {
        ...
        MessageInfo GetNextUndeliveredMessage(TimeSpan timeout, OperationContext context);

        SubscriptionInfo GetSubscriber(string topic, SubscriptionType type, OperationContext context);
        ...
        IDictionary<string, IList<object>> GetAssignedMessage(SubscriptionInfo subscriptionInfo, OperationContext operationContext);
        ...
        ArrayList GetTopicsState();

        void SetTopicsState(ArrayList topicState);
        ...
        Dictionary<string, TopicStats> GetTopicsStats();
