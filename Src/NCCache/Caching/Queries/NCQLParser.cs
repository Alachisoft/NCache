...
namespace Alachisoft.NCache.Caching.Queries
{
    public class NCQLParser : Alachisoft.NCache.Parser.Parser
    {
        ...
        private Reduction CreateNewObject(Reduction reduction)
        {
            ...
            {
                case RuleConstants.RULE_QUERY:
                    ////<Query> ::= <SelectQuery>
                    result = _parserRule.CreateRULE_QUERY(reduction);
                    break;
                case RuleConstants.RULE_QUERY_ORDERBY:
                    ////<Query> ::= <SelectQuery> 'ORDER BY' <OrderByValueList>
                    result = _parserRule.CreateRULE_QUERY_ORDERBY(reduction);
                    break;
                case RuleConstants.RULE_QUERY_DELETE:
                    ////<Query> ::= DELETE <DeleteParams>
                    result = _parserRule.CreateRULE_QUERY_DELETE(reduction);
                    break;
                case RuleConstants.RULE_QUERY_DELETE_WHERE:
                ...
                case RuleConstants.RULE_SELECTQUERY_SELECT:
                    ////<SelectQuery> ::= SELECT <ObjectType>
                    result = _parserRule.CreateRULE_SELECTQUERY_SELECT(reduction);
                    break;
                case RuleConstants.RULE_SELECTQUERY_SELECT_WHERE:
                    ////<SelectQuery> ::= SELECT <ObjectType> WHERE <Expression>
                    result = _parserRule.CreateRULE_SELECTQUERY_SELECT_WHERE(reduction);
                    break;
                case RuleConstants.RULE_SELECTQUERY_SELECT_GROUPBY:
                    ////<SelectQuery> ::= SELECT <AggregateFunction> 'GROUP BY' <ObjectAttributeList>
                    result = _parserRule.CreateRULE_SELECTQUERY_SELECT_GROUPBY(reduction);
                    break;
                case RuleConstants.RULE_SELECTQUERY_SELECT_WHERE_GROUPBY:
                    ////<SelectQuery> ::= SELECT <AggregateFunction> WHERE <Expression> 'GROUP BY' <ObjectAttributeList>
                    result = _parserRule.CreateRULE_SELECTQUERY_SELECT_WHERE_GROUPBY(reduction);
                    break;
                case RuleConstants.RULE_SELECTQUERY_SELECT_GROUPBY2:
                    ////<SelectQuery> ::= SELECT <GroupByValueList> 'GROUP BY' <ObjectAttributeList>
                    result = _parserRule.CreateRULE_SELECTQUERY_SELECT_GROUPBY2(reduction);
                    break;
                case RuleConstants.RULE_SELECTQUERY_SELECT_WHERE_GROUPBY2:
                    ////<SelectQuery> ::= SELECT <GroupByValueList> WHERE <Expression> 'GROUP BY' <ObjectAttributeList>
                    result = _parserRule.CreateRULE_SELECTQUERY_SELECT_WHERE_GROUPBY2(reduction);
                    break;
                ...
                case RuleConstants.RULE_AGGREGATEFUNCTIONLIST_COMMA:
                    ...
                    break;
                case RuleConstants.RULE_AGGREGATEFUNCTIONLIST:
                    ////<AggregateFunctionList> ::= <AggregateFunction>
                    result = _parserRule.CreateRULE_AGGREGATEFUNCTIONLIST(reduction);
                    break;
                case RuleConstants.RULE_ORDERBYVALUELIST_COMMA:
                    ////<OrderByValueList> ::= <OrderArgument> ',' <OrderByValueList>
                    result = _parserRule.CreateRULE_ORDERBYVALUELIST_COMMA(reduction);
                    break;
                case RuleConstants.RULE_ORDERBYVALUELIST:
                    ////<OrderByValueList> ::= <OrderArgument>
                    result = _parserRule.CreateRULE_ORDERBYVALUELIST(reduction);
                    break;
                case RuleConstants.RULE_ORDERARGUMENT:
                    ////<OrderArgument> ::= <ObjectAttribute> <Order>
                    result = _parserRule.CreateRULE_ORDERARGUMENT(reduction);
                    break;
                case RuleConstants.RULE_ORDERARGUMENT2:
                    ////<OrderArgument> ::= <ObjectAttribute>
                    result = _parserRule.CreateRULE_ORDERARGUMENT2(reduction);
                    break;
