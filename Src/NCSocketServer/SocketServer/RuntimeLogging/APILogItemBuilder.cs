...
{
    public class APILogItemBuilder
    {
        ...
        public void GenerateADDInsertAPILogItem(string key, object value, ArrayList dependency, long absoluteExpiration, long slidingExpiration, CacheItemPriority priority, Alachisoft.NCache.Caching.CacheSynchronization.CacheSyncDependency syncDependency, Hashtable Tags, string group, string subGroup, BitSet dsWriteOption, string providerName, string resyncProviderName,
            bool isResyncExpiredItems, Hashtable namedTags, short ondatasourceitemupdatedcallback, short onDataSourceItemAdded, bool asynCall, bool itemUpdate, bool itemRemove, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            ...
            foreach (Parameters param in parameter)
            {
                if (param.ParameterName != null)
                {
                    ...
                    else if (string.Equals("value", parameterName))
                    {
                        logItemParameters.Add("value", value);
                    }
                    else if (parameterName.Equals("tags", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("tags", Tags);
                    }
                    else if (string.Equals("namedtags".ToLower(), parameterName))
                    {
                        logItemParameters.Add("namedtags", namedTags);
                    }
                    ...
                    {
                        logItemParameters.Add("dswriteoption", dsWriteOption);
                    }
                    else if (parameterName.Equals("providername", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("providername", providerName);
                    }
                    else if (parameterName.Equals("resyncprovidername", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("resyncprovidername", resyncProviderName);
                    }
                    else if (parameterName.Equals("ondatasourceitemupdatedcallback", StringComparison.InvariantCultureIgnoreCase))
                    {
                        if (_methodName.ToLower() == "insert" || _methodName.ToLower() == "insertasync")
                        {
                            if (!logItemParameters.ContainsKey("ondatasourceitemupdatedcallback"))
                            {
                    ...
                    else if (parameterName.Equals("onDataSourceItemAdded", StringComparison.InvariantCultureIgnoreCase))
                    {
                        if (_methodName.ToLower() == "add" || _methodName.ToLower() == "addasync")
                        {
                            if (!logItemParameters.ContainsKey("ondatasourceitemadded"))
                            {
                    ...
                    else if (parameterName.Equals("onasyncitemupdatecallback", StringComparison.InvariantCultureIgnoreCase))
                    {
                        if (_methodName.ToLower() == "insertasync")
                        {
                            if (!logItemParameters.ContainsKey("onasyncitemupdatecallback"))
                            {
                                if (asynCall)
                    ...
                    else if (parameterName.Equals("onasyncitemaddcallback", StringComparison.InvariantCultureIgnoreCase))
                    {
                        if (_methodName.ToLower() == "addasync")
                        {
                            if (!logItemParameters.ContainsKey("onasyncitemaddcallback"))
                            {
                                if (asynCall)
                    ...
                    {
                        if (absoluteExpiration != -1 && !logItemParameters.ContainsKey("absoluteexpiration")) logItemParameters.Add("absoluteexpiration", absoluteExpiration);
                        if (slidingExpiration != -1 && !logItemParameters.ContainsKey("slidingexpiration")) logItemParameters.Add("slidingexpiration", slidingExpiration);
                        logItemParameters.Add("priority", priority);
                        logItemParameters.Add("value", value);
        ...
        public void GenerateADDInsertBulkAPILogItem(int keys, int value, ArrayList dependency, long absoluteExpiration, long slidingExpiration, CacheItemPriority priority, Alachisoft.NCache.Caching.CacheSynchronization.CacheSyncDependency syncDependency, Hashtable Tags, Hashtable namedTags, string group, string subGroup, BitSet dsWriteOption, string providerName,
            string resyncProviderName, bool isResyncExpiredItems, bool allowQueryTags, long version, short ondatasourceitemupdatedcallback, short ondatasourceitemadded, bool itemUpdate, bool itemRemove, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            ...
            foreach (Parameters param in parameter)
            {
                if (param.ParameterName != null)
                {
                    ...
                    {
                        if (_methodName.ToLower() == "insertbulk")
                        {
                            if (!logItemParameters.ContainsKey("ondatasourceitemupdatedcallback"))
                            {
                                if (ondatasourceitemupdatedcallback != -1)
                    ...
                    {
                        if (_methodName.ToLower() == "addbulk")
                        {
                            if (!logItemParameters.ContainsKey("ondatasourceitemadded"))
                            {
                                if (ondatasourceitemadded != -1)
                        ...
                        if (_methodName.ToLower() == "insertbulk")
                        {
                            if (!logItemParameters.ContainsKey("ondatasourceitemsupdatedcallback"))
                            {
                                if (ondatasourceitemadded != -1)
                    ...
                    else if (parameterName.Equals("ondatasourceitemsupdatedcallback", StringComparison.InvariantCultureIgnoreCase))
                    {
                        if (_methodName.ToLower() == "insertbulk")
                        {
                            if (!logItemParameters.ContainsKey("ondatasourceitemsupdatedcallback"))
                    ...
                    else if (parameterName.Equals("onDataSourceItemsAdded", StringComparison.InvariantCultureIgnoreCase))
                    {
                        if (_methodName.ToLower() == "addbulk")
                        {
                            if (!logItemParameters.ContainsKey("ondatasourceitemsadded"))
                            {
                                if (ondatasourceitemadded != -1)
        ...
        public void GenerateAddAttributeAPILogItem(string key, long absoluteExpiration, ArrayList dependency, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            ...
            foreach (Parameters param in parameter)
            {
                ...
                {
                    if (absoluteExpiration != -1) logItemParameters.Add("absoluteexpiration", absoluteExpiration);
        ...
        public void GenerateBulkGetAPILogItem(int keys, string providerName, BitSet dsReadOption, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP, int result)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
            ...
            foreach (Parameters param in parameter)
            {
                if (param.ParameterName != null)
                {
                    ...
                    {
                        logItemParameters.Add("dsreadoption", dsReadOption);
                    }
                    else if (parameterName.Equals("providerName ", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("providername", providerName);
        ...
        public void GenerateClearAPILogItem(BitSet updateOpt, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            ...
            foreach (Parameters param in parameter)
            {
                if (param.ParameterName != null)
                {
                    ...
                    {
                        logItemParameters.Add("dswriteoption", updateOpt);
                    }
                }
            }
            logItem.RuntimeParameters = logItemParameters;
        ...
        public void GenerateGetCacheItemAPILogItem(string key, string group, string subGroup, BitSet dsReadOption, long version, LockAccessType accessType, TimeSpan lockTimeout, string lockHandle, string providerName, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP, int result)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
        ...
        public void GenerateGetCacheStreamAPILogItem(string key, string group, string subGroup, StreamMode streamMode, Dependency dependency, long absoluteExpiration, long slidingExpiration, CacheItemPriority priority, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
            ...
            foreach (Parameters param in parameter)
            {
                if (param.ParameterName != null)
                {
                    ...
                    {
                        logItemParameters.Add("streammode", streamMode);
                    }
                    else if (parameterName.Equals("dependency", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("dependency", dependency);
        ...
        public void GenerateGetCommandAPILogItem(string key, string group, string subGroup, BitSet dsReadOption, long version, LockAccessType accessType, TimeSpan lockTimeout, object lockHandle, string providerName, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP, int result)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
        ...
        public void GenerateGetIfNewerAPILogItem(string key, string group, string subGroup, BitSet dsReadOption, long version, LockAccessType accessType, TimeSpan lockTimeout, LockHandle lockHandle, string providerName, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
        ...
        public void GenerateEntryProcessorAPILogItem(int keys, string entryProcessor, BitSet dsReadOption, string readProviderName, BitSet dsWriteOption, string writeProviderName, object[] arguments, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
            ...
            foreach (Parameters param in parameter)
            {
                if (param.ParameterName != null)
                {
                    ...
                    else if (parameterName.Equals("key", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("key", keys);
                    }
                    else if (parameterName.Equals("entryprocessor", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("entryprocessor", entryProcessor);
                    }
                    else if (parameterName.Equals("dsreadoption", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("dsreadoption", dsReadOption);
                    ...
                    {
                        logItemParameters.Add("dswriteoption", dsReadOption);
                    }
                    else if (parameterName.Equals("readprovidername", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("readprovidername", readProviderName);
                    }
                    else if (parameterName.Equals("writeprovidername", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("writeprovidername", writeProviderName);
                    }
                    else if (parameterName.Equals("arguments", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("arguments", arguments);
                    }
                }
            }
            logItem.RuntimeParameters = logItemParameters;
        ...
        public void GenerateAggregateTaskAPILogItem(string extractor, string aggregator, string query, byte[] parameters, string keyFilter, int timeout, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
            ...
            foreach (Parameters param in parameter)
            {
                ...
                {
                    parameterName = param.ParameterName.ToLower();
                    if (parameterName.Equals("extractor", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("extractor", extractor);
                    }
                    else if (parameterName.Equals("aggregator", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("aggregator", aggregator);
                    }
                    ...
                    else if (parameterName.Equals("timeout", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("timeout", timeout);
                    }
                }
            }
            logItem.RuntimeParameters = logItemParameters;
        ...
        public void GenerateRemoveAPILogItem(string key, BitSet dsWriteOption, object lockHandle, long version, LockAccessType accessType, string providerNames, short onDataSourceItemRemovedCallback, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            ...
            foreach (Parameters param in parameter)
            {
                if (param.ParameterName != null)
                {
                    ...
                    else if (parameterName.Equals("providernames", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("providernames", providerNames);
                    }
                    else if (parameterName.Equals("onDataSourceItemRemovedCallback", StringComparison.InvariantCultureIgnoreCase))
                    {
        ...
        public void GeneratHybridBulkAPILogItem(List<string> operations, bool compress, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
            ...
            foreach (Parameters param in parameter)
            {
                ...
                {
                    parameterName = param.ParameterName.ToLower();
                    if (parameterName.Equals("operations", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("operations", operations);
                    }
                    if (parameterName.Equals("compress", StringComparison.InvariantCultureIgnoreCase))
                    {
                        logItemParameters.Add("compress", compress);
                    }
                }
            }
            logItem.RuntimeParameters = logItemParameters;
        ...
        public void GeberateRegisterKeyNotificationCallback(string key, string updateCallback, string removeCallback, bool notifyOnItemExpiration, string filter, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
        }
        ...
        public void GenerateCacheSyncDependencyAPILogItem(string remotecacheid, string key, ArrayList dependency, bool isResyncRequired, int overload, string exceptionMesage, TimeSpan executionTime, string clientId, string clientIP)
        {
            List<Parameters> parameter = GetMethodsParameters(_methodName, overload);
            string parameterName = null;
            Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem logItem = new Alachisoft.NCache.Common.Monitoring.APILogging.APIRuntimeLogItem(exceptionMesage);
        ...
        public ArrayList AddHintToDependency(ExpirationHint hint, ref long absExpiration, ref long sldExpiration)
        {
            ...
            {
                return GetKeyDependency((Alachisoft.NCache.Caching.AutoExpiration.KeyDependency)hint);
            }
            else if (hint is Alachisoft.NCache.Caching.AutoExpiration.FileDependency)
            {
                return GetFileDependency((Alachisoft.NCache.Caching.AutoExpiration.FileDependency)hint);
            }
            else if (hint is Sql7CacheDependency)
            {
                return (GetSql7Dependency((Sql7CacheDependency)hint));
            }
            else if (hint is SqlYukonCacheDependency)
            {
                return (GetSqlYukonCacheDependency((SqlYukonCacheDependency)hint));
            }
            else if (hint is OleDbCacheDependency)
            {
                return (GetOleDbCacheDependency((OleDbCacheDependency)hint));
            }
            else if (hint is Alachisoft.NCache.Caching.AutoExpiration.OracleCacheDependency)
            {
                return (GetOracleCacheDependencyy((Alachisoft.NCache.Caching.AutoExpiration.OracleCacheDependency)hint));
            }
            else if (hint is FixedExpiration)
            {
        ...
        private ArrayList GetKeyDependency(Alachisoft.NCache.Caching.AutoExpiration.KeyDependency keyDep)
        {
            ArrayList list = new ArrayList();
            list.Add("Key Dependency with keys : ");
            foreach (string val in keyDep.CacheKeys)
            {
                list.Add(val);
            }
            list.Add("Start After Time: " + new DateTime(keyDep.StartAfterTicks).ToString());
            return list;
        }

        private ArrayList GetSqlYukonCacheDependency(Alachisoft.NCache.Caching.AutoExpiration.SqlYukonCacheDependency sql7Dep)
        {
            ArrayList list = new ArrayList();
            list.Add("SqlYukonCacheDependency : ");
            list.Add("Connection String: " + sql7Dep.ConnectionString);
            list.Add("Key : " + sql7Dep.QueryString);
            return list;
        }

        private ArrayList GetOleDbCacheDependency(Alachisoft.NCache.Caching.AutoExpiration.OleDbCacheDependency olDb)
        {
            ArrayList list = new ArrayList();
            list.Add("OleDbCacheDependency : ");
            list.Add("Connection String: " + olDb.ConnectionString);
            list.Add("Key : " + olDb.DbCacheKey);
            return list;
        }

        private ArrayList GetOracleCacheDependencyy(Alachisoft.NCache.Caching.AutoExpiration.OracleCacheDependency olDb)
        {
            ArrayList list = new ArrayList();
            list.Add("OracleCacheDependency : ");
            list.Add("Connection String: " + olDb.ConnectionString);
            list.Add("Key : " + olDb.QueryString);
            return list;
        }

        private ArrayList GetFileDependency(Alachisoft.NCache.Caching.AutoExpiration.FileDependency fileDep)
        {
            ArrayList list = new ArrayList();
            list.Add("FileDependency with File Names: ");
            foreach (string val in fileDep.fileNames)
            {
                list.Add(val);
            }
            list.Add("Start After Time: " + new DateTime(fileDep.StartAfterTicks).ToString());

            return list;
        }

        private ArrayList GetSql7Dependency(Sql7CacheDependency sql7Dep)
        {
            ArrayList list = new ArrayList();
            list.Add("Sql dependency : ");
            list.Add("Connection String: " + sql7Dep.ConnectionString);
            list.Add("Key : " + sql7Dep.DbCacheKey);
