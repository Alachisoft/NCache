...
#region Aync response to client stuff
        ...
        internal ClientManager(ConnectionManager conectionManager, Socket clientSocket, int size, int pinnedBufferSize)
        {
            ...
            //_clientSocketId = ((IPEndPoint)ClientSocket.RemoteEndPoint).Address.Address.ToString();
            ...
            //#if EXPRESS Numan Hanif [Express]
            //if (Alachisoft.NCache.Licensing.LicenseManager.Express)//Numan Hanif[Express] Runtime Check for Express
            {
...
#region Pending response queue modifications.
        ...
        internal void Dispose()
        {
            ...
            //            {
            //#if EXPRESS
            //                ((NCache)_cmdExecuter).Cache.DisconnectClient(_clientAddress);
            //#endif
        ...
        internal void Dispose(bool disposingIntentionally)
        {
            ...
            lock (_disposeSync)
            {
                ...
                //        {
                //            //object operation = PendingSendOperationQueue.Dequeue();
                ...
                //        {
                //            object bulkevent = _eventsQueue.Dequeue();
                ...
                if (_cmdExecuter != null)
                {
                    if (!_cacheStopped && _raiseClientDisconnectedEvent)
                    {
                        ...
                        {
                            //log.Append("\r\nError occurred while calling OnClientDisconnected: " + e.ToString());
