...
namespace Alachisoft.NCache.SocketServer.Command.ResponseBuilders
{
    ...
    {
        public static IList BuildResponse(HashVector getResult, int commandVersion, string RequestId, IList _serializedResponse, string intendedRecepient, int commandID, Caching.Cache cache)
        {
            ...
            {
                case 0: // Versions earlier than NCache 4.1 because all of them expect responses as one chunk
                    {
