...
namespace Alachisoft.NCache.SocketServer.CallbackTasks
{
    internal sealed class PollRequestCallback : ICallbackTask
    {
        ...
        internal PollRequestCallback(string clientId, int callbackId, EventType eventType)
        {
            _clientId = clientId;
        ...
        public void Process()
        {
            ...
            if (clientManager != null)
            {
                ...
                IList serializedResponse = Common.Util.ResponseHelper.SerializeResponse(response);
