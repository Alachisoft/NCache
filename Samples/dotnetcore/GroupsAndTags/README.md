...
This sample demonstrates the use of Group/Subgroup, Tags and NamedTags feature of NCache. 
	Group/Subgroup:
		Adds items with Group/Subgroup into the cache and uses API to get, update and remove items using Group/Subgroup.
	Tags:
		Adds items with Tags, and use different Tag API to fetch and remove tagged items from the cache.
	NamedTags:
